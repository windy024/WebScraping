...
library(understatr)
View(get_leagues_meta())
ars_1920 <- get_team_players_stats(team_name = "Arsenal", year = 2019)
...
epl_1920 <- get_league_teams_stats(league_name = "EPL",year = 2019)
